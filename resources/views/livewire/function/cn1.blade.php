<div>
    <div>
        ...
        <body>
            <div id="layout-wrapper">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">TÀI LIỆU TÍCH HỢP API</h4>
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="https://ecaptcha.sieuthicode.net/">Trang
                                                        chủ</a></li>
                                                <li class="breadcrumb-item">Tài liệu</li>
                                                <li class="breadcrumb-item active">TÀI LIỆU TÍCH HỢP API</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card ribbon-box">
                                        <div class="card-body">
                                            <div class="mb-5">
                                                <div class="ribbon ribbon-primary ribbon-shape ">TÀI LIỆU TÍCH HỢP API</div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 mb-3">
                                                    <div> <label for="basiInput" class="form-label">API KEY</label>
                                                        <div class="input-group mb-2"> <input type="text" id="copyapikey"
                                                                class="form-control" readonly
                                                                value="bdeb277383bb47ec4a5c443c653bb06a"> <button
                                                                onclick="copy()" data-clipboard-target="#copyapikey"
                                                                class="btn btn-primary copy" type="button">COPY</button> </div>
                                                        <div class="alert alert-primary alert-dismissible alert-outline fade show"
                                                            role="alert"> Vui lòng bảo mật thông tin API KEY trên, nếu lộ API
                                                            KEY vui lòng thay đổi mật khẩu để reset lại API KEY. <button
                                                ...
                                                <hr>
                                                <div class="col-lg-12 mb-3">
                                                    <div class="form-group mb-3"> <label>Kết nối với API thông qua API
                                                            KEY</label>
                                                        <div class="input-group"> <span class="input-group-text">POST</span>
                                                            <input type="text" class="form-control"
                                                                value="https://ecaptcha.sieuthicode.net/api/captcha/garena"
                                                                id="copylistService" readonly> <button onclick="copy()"
                                                                data-clipboard-target="#copylistService"
                                                                class="btn btn-primary copy" type="button">COPY</button> </div>
                                                    </div>
                                                    <p>Form-data</p>
                                                    <ul>
                                                        <li><b style="color: red;">api_key</b>: api_key của bạn.
                                                        </li>
                                                        <li><b style="color: red;">img_base64</b>: base64 image của bạn.</li>
                                                    </ul>
                                                    <p>Response</p>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-group"> <label>Kết quả trả về</label> <textarea
                                                            id="codeMirrorDemo1"></textarea> </div>
                                                </div>
                                                <hr>
                                            </div>
                                        </div>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script type="text/javascript">document.write(new Date().getFullYear())</script> © Anti Captcha
                                Việt - Giải mã captcha tốc độ cực nhanh, độ chính xác cao - ecaptcha.sieuthicode.net
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block"> Version <b style="color: red;">1.0.0</b> </div>
                            </div>
                        </div>
                    </div>
                </footer>
            ...
            <script
                src="/template/public/AdminLTE3/plugins/datatables/jquery.dataTables.min.js"></script>
            <script
            ...
            <link rel="stylesheet"
                href="/template/public/AdminLTE3/plugins/codemirror/theme/monokai.css">
            ...
            <script
                src="/template/public/AdminLTE3/plugins/codemirror/mode/htmlmixed/htmlmixed.js"></script>
