                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">CHỌN TỈNH THÀNH PHỐ, QUẬN HUYỆN, PHƯỜNG XÃ</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card ribbon-box">
                                        <div class="card-body">
                                            <div class="mb-5">
                                                <div class="ribbon ribbon-primary ribbon-shape ">CN4 Livewire
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 mb-3">
                                                    <div>
                                                        <object type="image/svg+xml" data="/svg/ray-so-export (1).svg">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card ribbon-box">
                                        <div class="card-body">
                                            <div class="mb-5">
                                                <div class="ribbon ribbon-primary ribbon-shape ">CN4 View
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 mb-3">
                                                    <div>
                                                        <object type="image/svg+xml" data="/svg/ray-so-export (2).svg">
                                                            Your browser does not support SVG
                                                        </object>
                                                    </div>
                                                </div>
